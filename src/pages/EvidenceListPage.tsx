  ...
  return (
    <main className="min-h-screen p-10">
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-[32px] font-semibold text-black">증거물 목록</h1>
          <p className="mt-2 text-[16px] text-[#555]">등록된 증거물을 확인합니다.</p>
        </div>
        <Link
          to="/home"
      ...
      <section className="overflow-hidden rounded-[10px] border border-[#d9d9d9] bg-white">
        <div className="grid grid-cols-2 bg-[rgba(167,193,255,0.29)] text-center text-[18px] font-medium">
          <div className="border-r border-[#d9d9d9] p-4">증거물 번호</div>
          <div className="p-4">증거물 이름</div>
        </div>
